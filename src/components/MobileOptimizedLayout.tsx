...
export const MobileOptimizedLayout: React.FC<MobileOptimizedLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      {/* Mobile Bottom Navigation - Higher z-index for accessibility */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-lg border-t border-white/20 z-50">
        <div className="safe-area-inset-bottom">
          <div className="grid grid-cols-4 h-16 px-2">
            ...
            <button
              onClick={onChatOpen}
              className="flex flex-col items-center justify-center space-y-1 text-white/70 hover:text-white transition-all duration-200 active:scale-95 relative px-1 z-10"
      ...
      {/* Floating Chat Button for Desktop - Adjusted z-index */}
      <button
        onClick={onChatOpen}
