...
export const MobileOptimizedLayout: React.FC<MobileOptimizedLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      {/* Mobile Bottom Navigation - Increased bottom padding for better accessibility */}
      ...
      <button
        onClick={onChatOpen}
        className="hidden md:flex fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-400 hover:to-blue-400 rounded-full shadow-2xl z-50 transition-all duration-300 hover:scale-110 items-center justify-center"
        aria-label="Open Chat Assistant"
      >
