...
const all2DGames: Game[] = [
  ...
  { id: 'focus-test', title: 'Focus Test', description: 'Maintain concentration under pressure', type: 'attention', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 40, icon: Target },
  { id: 'sequence-master', title: 'Sequence Master', description: 'Master complex sequences', type: 'memory', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 45, icon: Brain },
  { id: 'reflex-challenge', title: 'Reflex Challenge', description: 'Ultimate reflex testing', type: 'speed', category: '2d', difficulty: 'hard', estimatedTime: '1 min', xpReward: 35, icon: Zap },
  { id: 'logic-grid', title: 'Logic Grid', description: 'Solve complex logic puzzles', type: 'logic', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 50, icon: Grid3X3 },
  { id: 'memory-palace', title: 'Memory Palace', description: 'Build and navigate memory palaces', type: 'memory', category: '2d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 55, icon: Brain },
  ...
  { id: 'number-ninja', title: 'Number Ninja', description: 'Slice through number challenges', type: 'math', category: '2d', difficulty: 'medium', estimatedTime: '1 min', xpReward: 25, icon: Calculator },
  ...
  { id: 'word-storm', title: 'Word Storm', description: 'Weather the storm of words', type: 'language', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 40, icon: Brain },
  { id: 'pattern-dance', title: 'Pattern Dance', description: 'Dance through visual patterns', type: 'pattern', category: '2d', difficulty: 'medium', estimatedTime: '1 min', xpReward: 25, icon: Puzzle },
  { id: 'attention-storm', title: 'Attention Storm', description: 'Navigate through attention challenges', type: 'attention', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 45, icon: Eye },
  { id: 'sequence-storm', title: 'Sequence Storm', description: 'Weather complex sequence challenges', type: 'memory', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 40, icon: Brain },
  { id: 'reflex-master', title: 'Reflex Master', description: 'Become the ultimate reflex master', type: 'speed', category: '2d', difficulty: 'hard', estimatedTime: '1 min', xpReward: 45, icon: Timer },
  { id: 'logic-master', title: 'Logic Master', description: 'Master the art of logic', type: 'logic', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 50, icon: Brain },
  { id: 'brain-teaser', title: 'Brain Teaser', description: 'Ultimate brain challenge', type: 'logic', category: '2d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 45, icon: Brain }
];
...
const all3DGames: Game[] = [
  ...
  { id: 'vector-master', title: 'Vector Master', description: 'Master 3D vector calculations', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 50, icon: Compass },
  { id: 'dimension-weaver', title: 'Dimension Weaver', description: 'Weave through dimensions', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 60, icon: Box },
  { id: 'spatial-memory', title: 'Spatial Memory', description: 'Remember 3D spatial arrangements', type: 'spatial', category: '3d', difficulty: 'medium', estimatedTime: '2 min', xpReward: 40, icon: Brain },
  { id: 'geometry-master', title: 'Geometry Master', description: 'Master 3D geometry', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 50, icon: Octagon },
  { id: 'rotation-symphony', title: 'Rotation Symphony', description: 'Create symphonies with rotations', type: 'spatial', category: '3d', difficulty: 'medium', estimatedTime: '2 min', xpReward: 35, icon: Music },
  { id: 'tesseract-navigator', title: 'Tesseract Navigator', description: 'Navigate 4D tesseracts', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 65, icon: Square },
  { id: 'quantum-tunnels', title: 'Quantum Tunnels', description: 'Tunnel through quantum space', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 55, icon: Radar },
  { id: 'fractal-explorer', title: 'Fractal Explorer', description: 'Explore infinite fractal dimensions', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 60, icon: Sparkles },
  ...
  { id: 'matrix-navigator', title: 'Matrix Navigator', description: 'Navigate through data matrices', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 50, icon: Grid3X3 },
  { id: 'cosmic-architect', title: 'Cosmic Architect', description: 'Architect of cosmic structures', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 60, icon: Star },
  { id: 'reality-shifter', title: 'Reality Shifter', description: 'Shift between realities', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 65, icon: Sparkles },
  { id: 'void-walker', title: 'Void Walker', description: 'Walk through the void', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 55, icon: Box },
  { id: 'dimension-builder', title: 'Dimension Builder', description: 'Build your own dimensions', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 60, icon: Box },
  { id: 'space-time-weaver', title: 'Space-Time Weaver', description: 'Weave space and time', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 70, icon: Clock },
  { id: 'hypercube-master', title: 'Hypercube Master', description: 'Master hypercube navigation', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '3 min', xpReward: 65, icon: Box },
  { id: 'quantum-entangler', title: 'Quantum Entangler', description: 'Entangle quantum particles', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '2 min', xpReward: 60, icon: Sparkles },
  { id: 'multiverse-explorer', title: 'Multiverse Explorer', description: 'Explore infinite multiverses', type: 'spatial', category: '3d', difficulty: 'hard', estimatedTime: '4 min', xpReward: 75, icon: Globe }
];
